...
import { AnimatedBackground } from "@/components/ui/animated-background" // Importar el fondo animado
  ...
  return (
    <>
      ...
      <main className="relative overflow-hidden">
        {" "}
        {/* Añadido relative y overflow-hidden aquí */}
        <AnimatedBackground /> {/* Fondo animado detrás de todo el contenido */}
        <div className="container mx-auto px-4 py-12 relative z-10">
          ...
          <div className="flex flex-col items-center text-center mb-24 pt-10">
            ...
            >
              {/* Las blob-shapes originales se pueden mantener o eliminar si AnimatedBackground es suficiente */}
          ...
          <motion.div
            ...
            className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-24" // Aumentado mb
          >
            <FeatureCard
          ...
          >
            <h2 className="text-3xl font-bold mb-6 text-deep-blue dark:text-slate-100">
              ¿Por qué elegir Physio Health?
            </h2>
  ...
  return (
    ...
    >
      <Card className="h-full overflow-hidden shadow-xl bg-gradient-to-br from-mint/20 to-sky-blue/20 dark:from-mint/10 dark:to-sky-blue/10 border border-slate-200 dark:border-slate-700 flex flex-col">
        <CardHeader className="p-6 flex-grow text-center">
          {" "}
          {/* Añadido text-center */}
          <div className="p-3 bg-white/80 dark:bg-slate-900/80 rounded-full shadow-md mb-5 inline-block mx-auto">
            {icon}
          </div>{" "}
          {/* Añadido mx-auto */}
        ...
        <CardFooter className="p-6 pt-0 mt-auto">
          {" "}
          {/* Añadido mt-auto para empujar el footer hacia abajo */}
          <Button
            asChild
...
function BenefitCard({
  ...
  // El icono aquí ya debería estar centrado debido a 'items-center' en el div padre.
  return (
    <motion.div
      initial={{ opacity: 0, y: 20 }}
      animate={{ opacity: 1, y: 0 }}
